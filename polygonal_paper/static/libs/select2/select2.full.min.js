        ...
        return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, r = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function (e, t) {
            ...
            return f.Extend(i, f.Observable), i.prototype.render = function () {
                ...
                this.$results.attr("id", n), t.on("results:all", function (e) {
                    ...
                    var e = l.getHighlightedResults(),
                        t = l.$results.find("[aria-selected]"), n = t.index(e);
                    if (!(n <= 0)) {
                        var i = n - 1;
                        0 === e.length && (i = 0);
                        var r = t.eq(i);
                        r.trigger("mouseenter");
                        var o = l.$results.offset().top, s = r.offset().top,
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var n = "scroll.select2." + t.id, i = "resize.select2." + t.id,
                ...
                var s = this.$dropdown.outerHeight(!1), a = e.scrollTop(),
                    l = e.scrollTop() + e.height(), c = a < r.top - s,
                    u = l > r.bottom + s, d = {left: r.left, top: o.bottom},
